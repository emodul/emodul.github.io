...
$sql = "INSERT INTO tbl_sejarah (judul,guru) VALUES ('$judul','$guru')";
mysqli_query($koneksi,$sql);

$query = mysqli_query($koneksi,"SELECT id FROM tbl_sejarah ORDER BY id DESC LIMIT 1");
...
mysqli_query($koneksi,"UPDATE tbl_sejarah SET nama_file='$nama_baru' WHERE id='$data[id]' ");
