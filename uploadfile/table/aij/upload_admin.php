...
$sql = "INSERT INTO tbl_aij (judul,guru) VALUES ('$judul','$guru')";
mysqli_query($koneksi,$sql);

$query = mysqli_query($koneksi,"SELECT id FROM tbl_aij ORDER BY id DESC LIMIT 1");
...
mysqli_query($koneksi,"UPDATE tbl_aij SET nama_file='$nama_baru' WHERE id='$data[id]' ");
