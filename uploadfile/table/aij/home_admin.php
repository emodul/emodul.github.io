...
<html lang="en">
 ...
 <head>
    <title>Home Administrasi infrastruktur Jaringan</title>
  ...
  <body>
    ...
    <table id="tabel-data" class="table table-striped">
      ...
      <?php
                $data = mysqli_query($koneksi, "SELECT * from tbl_aij");
        ...
        $hapus = "hapus_admin.php?id=".$d['id'];
        $edit = "edit_admin.php?id=" .$d['id'];
        ?>
        <tr>
          <td><?php echo $no;?></td>
