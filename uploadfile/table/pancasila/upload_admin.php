...
$sql = "INSERT INTO tbl_pancasila (judul,guru) VALUES ('$judul','$guru')";
mysqli_query($koneksi,$sql);

$query = mysqli_query($koneksi,"SELECT id FROM tbl_pancasila ORDER BY id DESC LIMIT 1");
...
mysqli_query($koneksi,"UPDATE tbl_pancasila SET nama_file='$nama_baru' WHERE id='$data[id]' ");
...
<script>
	alert('<?php echo $pesan;?>'); location='home_admin.php';
</script>