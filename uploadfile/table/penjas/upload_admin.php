...
$sql = "INSERT INTO tbl_penjas (judul,guru) VALUES ('$judul','$guru')";
mysqli_query($koneksi,$sql);

$query = mysqli_query($koneksi,"SELECT id FROM tbl_penjas ORDER BY id DESC LIMIT 1");
...
mysqli_query($koneksi,"UPDATE tbl_penjas SET nama_file='$nama_baru' WHERE id='$data[id]' ");
