...
$sql = "INSERT INTO tbl_bingg (judul,guru) VALUES ('$judul','$guru')";
mysqli_query($koneksi,$sql);

$query = mysqli_query($koneksi,"SELECT id FROM tbl_bingg ORDER BY id DESC LIMIT 1");
...
mysqli_query($koneksi,"UPDATE tbl_bingg SET nama_file='$nama_baru' WHERE id='$data[id]' ");
