...
$sql = "INSERT INTO tbl_kimia (judul,guru) VALUES ('$judul','$guru')";
mysqli_query($koneksi,$sql);

$query = mysqli_query($koneksi,"SELECT id FROM tbl_kimia ORDER BY id DESC LIMIT 1");
...
mysqli_query($koneksi,"UPDATE tbl_kimia SET nama_file='$nama_baru' WHERE id='$data[id]' ");
